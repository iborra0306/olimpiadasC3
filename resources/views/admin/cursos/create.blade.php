                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('cursos.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="curso_moodle_id" id="curso_moodle_id" value="{{ old('curso_moodle_id') }}" class="w-full border-gray-300 rounded-md">
                        </div>
                        <div class="mb-4">
                            <label for="numero_olimpiada" class="block text-gray-700">Numero Olimpiada</label>
                            <input type="number" name="numero_olimpiada" id="numero_olimpiada" value="{{ old('numero_olimpiada') }}" class="w-full border-gray-300 rounded-md">
                        </div>
                        <div class="mb-4">
                            ...
                            <select name="edicion_id" id="edicion_id" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <option value="">-- Selecciona el curso escolar --</option>

                                @foreach($ediciones as $edicion)
                                    <option value="{{ $edicion->id }}" {{ old('edicion_id') == $edicion->id ? 'selected' : '' }}>
